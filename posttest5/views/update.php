<?php
    ...
    if (isset($_POST['updatedata'])) {
        ...
        $result = mysqli_query($conn, "UPDATE album SET id = '$id', album = '$album', artist = '$artist', release_year = '$release_year', genre = '$genre' WHERE id = $id");
        ...
        <div class="form-box">
            ...
            <form action="update.php" method="post">
                <div class="input-box">
                    ...
                    <input type="text" class="input" name="id" value="<?php echo $album['id']?>" required>
                </div>
                <div class="input-box">
