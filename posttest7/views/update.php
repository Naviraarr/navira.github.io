<?php
    ...
    if (isset($_POST['updatedata'])) {
        ...
        $result = mysqli_query($conn, "UPDATE album SET album = '$album', cover = '$cover', artist = '$artist', release_year = '$release_year', genre = '$genre' WHERE id = '$id'");
    ...
    <div class="container">
        <div class="form-box">
            ...
            <form action="update.php" method="post">
                ...
                <div class="input-box">
                    <label for="artist">Album Cover</label>
                    <input type="file" class="input" name="cover" value="<?php echo $album['cover']?>" required>
                </div>
                <div class="input-box">
